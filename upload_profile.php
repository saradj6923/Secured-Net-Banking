					...
					<div class="navbar-header">
					  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<div class="w3layouts-logo">
							<h1><a href="index.html">Secured Netbanking</span></a></h1>
						</div>
					</div>
...
<div class="container">
		<?php	
          $uname=$_GET['uname'];
		   ...
		   $add= $row_query + 1;	
            $path=$_SERVER['DOCUMENT_ROOT'].'/securednetbanking/uploads';
...
<form method="post" action="">
   ...
   <div class="row">
   <?php	$select =mysqli_query($con,"SELECT * FROM my_profiles where username='$uname'");
		while ($row=mysqli_fetch_array($select)) 
		{    ?>
    <div class="col-sm-2">
	<?php echo '<img alt="" class="img-responsive" src="uploads/'.$row["file"].'" style="width:100px;height:100px;">' ;?>
    <br><input type="radio" name="img_id" value="<?php echo $row["profiles_id"];?>" required>
