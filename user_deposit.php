...
<div id="content">
	 <!-- <div class="aecenter">-->
	 			<center>
	 			  <FONT color="#993399" size="+1"> DEPOSIT ENTRY </FONT> 
              </center>
		 			<table border="1" align="center" width="50%" height="65%">
						...
						<tr>  
             			 		<td align="center" width="50%">
                 						<b> <font>Deposit Amount </font></b>             			 		</td>
            			 		<td width="50%" bgcolor="#CCCCCC"><input type="text" name="Amount" /> </td>
           			  </tr>
						<tr>  
              					<td align="center" width="50%" bgcolor="">
					  					<b><font>Date </font></b>                        		</td>
             					<td width="50%" bgcolor="#CCCCCC"><input type="text" name="Date" /></td>
       	    		  </tr>
					   <tr>  
              					<td align="center" width="50%" bgcolor="">
					  					<b><font>From which A/C Number </font></b>                        		</td>
             					<td width="50%" bgcolor="#CCCCCC"><input type="text" name="Transaction_Ac" /></td>
       	    		  </tr>           				
	 ...
	 <?php
	    include('db.php');
								  ...
								  {
										extract($_POST);		
										$insert=mysqli_query($con,"insert into ac_transaction values('','$accno','$Date','Deposit','$Amount','$Transaction_Ac')")  or die(mysql_error());
											if($insert)
											{
