					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="admin1.php" class="hvr-sweep-to-bottom">Admin_Login</a></li>
								<li class="active"><a href="login.php" class="hvr-sweep-to-bottom">User_Login</a></li>
								
								<li><a class="hvr-sweep-to-bottom"  href="registration.php">Registration</a></li>
							</ul>
						</nav>
					</div>
					<!-- /.navbar-collapse -->
			...
			<div class="signin-form profile">
				...
				<?php include('user_login.php'); ?>
					<form method="post" action="">
						<input type="email" name="uname" placeholder="Enter User email" required="">
